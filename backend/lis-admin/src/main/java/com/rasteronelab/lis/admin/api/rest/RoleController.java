...
import com.rasteronelab.lis.admin.application.service.RoleService;
...
public class RoleController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<PagedResponse<RoleResponse>>> getAll(Pageable pageable) {
        Page<RoleResponse> page = roleService.getAll(pageable);
        return ResponseEntity.ok(ApiResponse.success(PagedResponse.of(page)));
    }

    @GetMapping("/search")
    public ResponseEntity<ApiResponse<PagedResponse<RoleResponse>>> search(
            @RequestParam String query, Pageable pageable) {
        Page<RoleResponse> page = roleService.search(query, pageable);
        return ResponseEntity.ok(ApiResponse.success(PagedResponse.of(page)));
    }
