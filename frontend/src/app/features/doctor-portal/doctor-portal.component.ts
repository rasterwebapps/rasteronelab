...
@Component({
  ...
  template: `
    <div class="grid gap-6">
      ...
      <mat-card>
        <mat-card-header>
          <div mat-card-avatar class="flex items-center justify-center w-10 h-10 rounded-full bg-teal-100">
            <mat-icon class="text-teal-600">medical_services</mat-icon>
          </div>
          <mat-card-title>Doctor Portal</mat-card-title>
          <mat-card-subtitle>Referring doctor access to orders, results &amp; reports</mat-card-subtitle>
        </mat-card-header>
        <mat-card-content>
          ...
          <mat-card-content>
            <mat-list>
              @for (feature of features; track feature) {
                <mat-list-item>
                  <mat-icon matListItemIcon class="text-teal-500">check_circle_outline</mat-icon>
            ...
            <div class="mt-4 space-y-4">
              ...
              <div class="flex items-center gap-3 p-3 rounded-lg bg-blue-50">
                ...
                <div>
                  ...
                  <div class="text-xs text-gray-500">Full Reports module completion required</div>
                </div>
              </div>
            </div>
          </mat-card-content>
...
export class DoctorPortalComponent {
  readonly features = [
    ...
    'Lab Report Viewer',
    'Patient Results Access',
    'Email/SMS Result Alerts',
